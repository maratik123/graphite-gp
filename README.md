...
cargo test             # 300 workspace tests green (98 gp-core; 198 gp-render: design tokens, fonts, tessellation smoke + golden guard, icon pipeline, core widgets + forms widgets + game HUD widgets + MovePad + track canvas + analytics overlays/notebook grid + setup screen + gallery/track/overlay/setup goldens; 2 gp-gen; 2 doc-tests)
```
