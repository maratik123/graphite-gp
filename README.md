...
cargo test             # 308 workspace tests green (100 gp-core; 204 gp-render: design tokens, fonts, tessellation smoke + golden guard, icon pipeline, core widgets + forms widgets + game HUD widgets + MovePad + track canvas + analytics overlays/notebook grid + setup screen + track lab screen + gallery/track/overlay/setup/lab goldens; 2 gp-gen; 2 doc-tests)
```
