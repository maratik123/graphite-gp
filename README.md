...
cargo test             # 216 workspace tests green (98 gp-core; 114 gp-render: design tokens, fonts, tessellation smoke + golden guard, icon pipeline, core widgets + forms widgets + game HUD widgets + MovePad + gallery goldens; 2 gp-gen; 2 doc-tests)
```
